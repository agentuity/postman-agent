...
if (!process.env.GITHUB_SECRET) {
  console.error(
    "\x1b[31m[ERROR] GITHUB_SECRET is not set. This should be added to the .env file.\x1b[0m"
  );
  process.exit(1);
}
...
if (!process.env.GITHUB_PAT) {
  console.error(
    "\x1b[31m[ERROR] GITHUB_PAT is not set. This should be added to the .env file.\x1b[0m"
  );
  process.exit(1);
}
